...
void update2(int node, int node_low, int node_high, int query_low, int query_high, int v){
  ...
  int last_in_left = (node_low+node_high)/2;
  update2(2*node, node_low, last_in_left, query_low, query_high, v);
  update2(2*node+1, last_in_left+1, node_high, query_low, query_high, v);
